kafka-streams-application-reset \
    ...
    --input-topics=gstp.risk.liabilities.bets.individual.stage,gstp.risk.liabilities.selections.outcomes.stage,gstp.risk.liabilities.resulting.compositeidlookup.stage,gstp.risk.liabilities.resulting.resultedids.stage \
    --to-latest \
