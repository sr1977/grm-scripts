kafka-streams-application-reset \
    ...
    --input-topics=gstp.risk.liabilities.bets.individual.stage,gstp.risk.liabilities.selections.outcomes.stage,gstp.risk.liabilities.resulting.compositeidlookup.stage \
    --to-latest \
