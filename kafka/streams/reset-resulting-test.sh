kafka-streams-application-reset \
    ...
    --input-topics=gstp.risk.liabilities.bets.individual.test,gstp.risk.liabilities.selections.outcomes.test,gstp.risk.liabilities.resulting.compositeidlookup.test \
    --to-latest \
