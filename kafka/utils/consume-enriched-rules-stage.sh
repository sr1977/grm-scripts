 ~/workspace/confluent-5.5.1/bin/kafka-avro-console-consumer \
    ...
    --topic=gstp.risk.alerting.config.enriched.stage \
    --group=simplealerts-stage-debug \
    --property print.key=true \
    --property schema.registry.url=https://schema-registry.test.platformservices.io \
    --value-deserializer io.confluent.kafka.serializers.KafkaAvroDeserializer \
    --key-deserializer org.apache.kafka.common.serialization.StringDeserializer \
    --consumer.config /Users/sri01/workspace/grm-scripts/kafka/keystores/simplealerts-stage.properties 
